...
import "../styles/OutwardAccounts.css";
import API from "../config/api";

const OutwardAccounts = () => {
...
const handleSubmit = async (e) => {
  ...
  return (
    <div className="acc-container">
      <h2 className="acc-heading">OUTWARD</h2>
      <h3 className="acc-subheading">Accounts Branch</h3>

      <form className="acc-box" onSubmit={handleSubmit}>
        {/* Outward No + Date */}
        ...
        {/* File Upload */}
        <div className="account-field file-upload-section">
  <div className="upload-row">
    ...
    <div className="account-upload-box">
      ...
      <button
        type="button"
        className="account-add-file-btn"
  ...
  <div className="account-selected-files-list">
    {fileInputs.map((f) => {
      if (!f.file) return null;
      return (
        <div key={f.id} className="account-file-row">
          <span className="account-file-name">{f.file.name}</span>
          <button
            type="button"
            className="account-remove-btn"
            onClick={() =>
              setFileInputs(fileInputs.filter((item) => item.id !== f.id))
            }
          >
            ❌
          </button>
        ...
        {/* Buttons */}
        <div className="acc-button-area">
          <button type="submit" className="acc-btn-submit">
            SUBMIT
          </button>
          <button
            type="button"
            className="acc-btn-clear"
            onClick={handleClear}
          >
            CLEAR
          </button>
...
export default OutwardAccounts;