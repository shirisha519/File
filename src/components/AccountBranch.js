...
import "../styles/AccountBranch.css";
 ...
 const handleChooseFile = (e) => {
  ...
  return (
    <div className="accounts-form-page">
      <h2 className="accounts-form-title">INWARD</h2>
      <h2 className="accounts-sub-title">New Receipts - Accounts Branch</h2>

      <form className="accounts-form" onSubmit={handleSubmit}>
        {/* Top Row */}
        <div className="accounts-top-row">
          <div className="accounts-form-group left">
            <label>Inward No:</label>
            <input type="text" value={inwardNo} readOnly />
          </div>

          <div className="accounts-form-group right">
            <label>Date:</label>
            <input
              type="date"
              name="date"
        ...
        <div className="accounts-form-row">
          <label>Seat No:</label>
          <input type="text" name="seatNo" value={formData.seatNo} onChange={handleChange} required />
        </div>

        <div className="accounts-form-row">
          <label>File No:</label>
          <input type="text" name="fileNo" value={formData.fileNo} onChange={handleChange} required />
        </div>
        ...
        <div className="accounts-form-row">
          ...
          <select name="receivedFrom" value={formData.receivedFrom} onChange={handleChange} required>
        ...
        <div className="accounts-form-row">
           <label>File Status:</label>
            <select name="fileStatus" value={formData.fileStatus} onChange={handleChange} required> 
        ...
        <div className="accounts-form-row">
          <label>Subject:</label>
          <textarea name="subject" value={formData.subject} onChange={handleChange} rows="3" required />
        </div>
...
<div className="file-upload-section1">
          ...
          <div className="selected-files-list1">
            {fileInputs.map((f) => {
              if (!f.file) return null;

              return (
                <div key={f.id} className="file-row1">
                  <span className="file-name1">{f.file.name}</span>
                  <button
                    type="button"
        ...
        <div className="accounts-form-buttons">
          <button type="submit" className="accounts-submit-btn">SUBMIT</button>
          <button type="button" className="accounts-clear-btn" onClick={handleClear}>CLEAR</button>
        </div>
      </form>
    </div>
  );
