...
import "../styles/TapalReceived.css";
...
const TapalReceived = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const res = await API.post("/api/tapal/received/add", formData);
      alert("Tapal received successfully! ID: " + res.data.id);
      console.log(res.data);
      handleClear(); // optional: clear form after submit
    } catch (err) {
      console.error(err);
      alert("Error submitting Tapal. Please try again.");
    }
  };
  ...
  return (
    <div className="tapal-received-page">
      <div className="tapal-container">
        <h2 className="tapal-title">TAPAL TRACKING SYSTEM</h2>
        <h3 className="tapal-subtitle">TAPAL RECEIVED</h3>

        {/* ✅ Tapal Box */}
        <div className="tapal-box">
          {/* Top Row - Inward No and Date */}
          <div className="tapal-header-row">
          ...
          {/* Main Form */}
          <form onSubmit={handleSubmit} className="tapal-form">
            <div className="form-row">
