...
import "../styles/PendingFilesAdmin.css";



const PendingFilesAdmin = () => {
...
------------------------------------------------------------\n`;
  ...
  return (
    <div className="pf-admin-container">
      ...
      <h2 className="pf-admin-heading">PENDING FILES</h2>
      <h3 className="pf-admin-subheading">Admin Branch</h3>

      <div className="pf-admin-box">
        ...
        <div className="pf-button-row">
          <button className="pf-search-btn" onClick={handleSearch}>
            Search
          </button>

          <button className="pf-view-btn" onClick={handleView}>
            View
          </button>

          <button className="pf-download-btn" onClick={handleDownload}>
            Download
          </button>
        </div>
      </div>

      <textarea className="pf-textarea" value={output} readOnly></textarea>

      <button className="pf-print-btn" onClick={handlePrint}>PRINT</button>
    </div>
  );
};

export default PendingFilesAdmin;
