...
import "../styles/TapalDispatched.css";

const TapalDispatched = () => {
  ...
  e.preventDefault();
  try {
    const res = await API.post("/api/tapal/dispatched", formData);
    alert("Tapal dispatched successfully! ID: " + res.data.id);
    console.log(res.data);
    setFormData({ ...formData, dispatchedTo: "", remarks: "", note: "" });
  } catch (err) {
    console.error(err);
    alert("Error dispatching Tapal. Please try again.");
  }
};
  ...
  return (
    <div className="tapal-dispatched-page">
    <div className="tapal-dispatch-container">
      <h2 className="tapal-dispatch-title">TAPAL Tracking System</h2>
      <h3 className="tapal-dispatch-subtitle">TAPAL Dispatched</h3>

      <div className="tapal-dispatch-box">
        <div className="tapal-dispatch-header">
          <div>
            ...
            <input
              ...
              className="tapal-dispatch-inward-input"
            />
          </div>
          <div>
            <label>Date:</label>
        ...
        <div className="tapal-dispatch-row">
          <div className="tapal-dispatch-group tapal-dispatch-half-width">
        ...
        <div className="tapal-dispatch-buttons">
          <button onClick={handleAdd} className="tapal-dispatch-add-btn">
            ADD
          </button>
        </div>
      </div>
      ...
      <textarea
        className="tapal-dispatch-textarea"
        rows="8"
      ...
      <div className="tapal-dispatch-buttons">
        <button onClick={handlePrint} className="tapal-dispatch-print-btn">
          PRINT
        </button>
      </div>
    </div>
...
export default TapalDispatched;
